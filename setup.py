...
setup(
    ...
    scripts=['lucterios/install/lucterios_admin.py', 'lucterios/install/lucterios_gui.py', 'lucterios/install/lucterios_qt.py'],
    package_data={
    ...
    install_requires=["pip ~=20.0", "Django ~=2.2", "django-fsm ~=2.7", "lxml ~=4.4", "Pillow ~=6.2", "reportlab ~=3.5", "APScheduler ~=3.6", "Babel ~=2.7", "pyqt5 ~=5.13"],
)
