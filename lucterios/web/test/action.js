...
test( "Action", function() {
	var action= "<ACTION icon='images/edit.png' extension='CORE' action='extension_params_APAS_modifier' close='0' modal='1' unique='1'><![CDATA[_Modifier]]></ACTION>".parseXML();
	this.mAction.initialize(null, null, action);
	...
	equal(this.mAction.getAction(), "extension_params_APAS_modifier", "Action");
...
test( "Menu", function() {
	var action="<MENU id='Im_pressionsauvegardees' extension='CORE' action='finalreport_APAS_list'><![CDATA[Im_pression sauvegardees]]></MENU>".parseXML();
	this.mAction.initialize(null, null, action);
...
test( "Simple", function() {
	...
	var action="<ACTION extension='CORE' action='extension_params_APAS_modifier' close='0' modal='1'><![CDATA[_Modifier]]></ACTION>".parseXML();
	...
	equal(ObserverFactoryMock.LastAction, "extension_params_APAS_modifier", "action");
...
test( "CloseParent", function() {
	...
	var action = "<ACTION extension='CORE' action='extension_params_APAS_modifier' close='1' modal='1'><![CDATA[_Modifier]]></ACTION>".parseXML();
...
test( "NoCloseParent", function() {
	...
	var action="<ACTION extension='CORE' action='extension_params_APAS_modifier' close='0' modal='1' unique='0'><![CDATA[_Modifier]]></ACTION>".parseXML();
	this.mAction.initialize(obs_parent, fact, action);
	this.mAction.actionPerformed();
...
test( "OnlyCloseParent", function() {
	...
	var action="<ACTION close='1' modal='0'><![CDATA[_Close]]></ACTION>".parseXML();
	this.mAction.initialize(obs_parent, fact, action);
	this.mAction.actionPerformed();
