...
$.widget("ui.timespinner", $.ui.spinner, {
    ...
    _format: function(value) {
        "use strict";
        var current_hour = Math.floor(value / 60),
            current_min = value - current_hour * 60;
...
var GUIBasic = Class.extend({
    ...
    moveCenter: function() {
        var dlg = $("#" + this.mId).parent(),
            new_left = (screen.width / 2) - (dlg.width() / 2),
            new_top = (screen.height / 2) - (dlg.height() / 2);
        dlg.offset({
            top: new_top,
            left: new_left
        });
