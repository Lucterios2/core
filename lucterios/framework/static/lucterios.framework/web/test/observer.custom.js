...
test("Custom_Grid", function() {
	...
	var table_comp = jcnt.find("table:eq(0) > tbody > tr:eq(2) > td:eq(0) > table:eq(0)");
	var table_content = table_comp.find("tbody > tr:eq(0) > td:eq(0)");
	var table_buttons = table_comp.find("tbody > tr:eq(0) > td:eq(1)");

	var comp = table_content.find("table:eq(0) > thead > tr:eq(0) > th:eq(0)");
	equal(comp.html(), "code postal", "head 1");
	var comp = table_content.find("table:eq(0) > thead > tr:eq(0) > th:eq(1)");
	equal(comp.html(), "ville", "head 2");
	var comp = table_content.find("table:eq(0) > thead > tr:eq(0) > th:eq(2)");
	equal(comp.html(), "pays", "head 3");

	var cell1 = table_content.find("table:eq(0) > tbody > tr:eq(0) > td:eq(0)");
	equal(cell1.html(), "38420", "cell 1");
	var cell2 = table_content.find("table:eq(0) > tbody > tr:eq(1) > td:eq(1)");
	equal(cell2.html(), "LE VERSOUD", "cell 2");
	var cell3 = table_content.find("table:eq(0) > tbody > tr:eq(2) > td:eq(2)");
	equal(cell3.html(), "France", "cell 3");
