...
var compGeneric = compBasic.extend({
	...
	initial : function(component) {
		if (this.name === '') {
			...
			this.description = component.description ? component.description : '';
			...
			this.x = component.x;
			this.y = component.y;
			this.vmin = component.VMin ? parseInt(component.VMin) : -1;
			this.hmin = component.HMin ? parseInt(component.HMin) : -1;
