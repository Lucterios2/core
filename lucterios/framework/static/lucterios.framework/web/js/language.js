...
g_translation.fr.put("Use the <i>Lucterios</i> framework",
		"Utilise le cadre d'application <i>Lucterios</i>");
...
g_translation.en.put("Describ your problem.<br>Thanks<br><br>",
		"Describ your problem.<br>Thanks<br><br>");
g_translation.en.put("Bug report", "Bug report");
g_translation.en.put("Version", "Version");
g_translation.en.put("Use the <i>Lucterios</i> framework",
		"Use the <i>Lucterios</i> framework");
g_translation.en.put("Server", "Server");
g_translation.en.put("AJAX client", "AJAX client");
g_translation.en.put("Tool of customize management on GPL license",
...
g_translation.en.put("Upload impossible<br/>The file must be less than {0}Mo ",
...
g_translation.en.put("Connection forbideen in this localisation!",
		"Connection forbiden from this localisation!");
g_translation.en.put("Connection", "Connection");
