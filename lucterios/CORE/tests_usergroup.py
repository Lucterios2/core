...
class UserTest(LucteriosTest):
    ...
    def test_userlist(self):
        ...
        self.assert_json_equal('LABELFORM', "title", '{[br/]}{[center]}{[u]}{[b]}Utilisateurs du logiciel{[/b]}{[/u]}{[/center]}')
...
class GroupTest(LucteriosTest):
    ...
    def test_grouplist(self):
        ...
        self.assert_comp_equal(('LABELFORM', "title"), '{[br/]}{[center]}{[u]}{[b]}Les groupes{[/b]}{[/u]}{[/center]}', ('1', '0', '1', '1'))
...
class SessionTest(LucteriosTest):
    ...
    def test_sessionlist(self):
        ...
        self.assertEqual(self.json_meta['title'], 'Sessions')
        self.assertEqual(len(self.json_context), 0)
        self.assertEqual(len(self.json_actions), 1)
        self.assert_action_equal(self.json_actions[0], ('Fermer', 'images/close.png'))
        self.assert_count_equal('', 3)
        ...
        self.assert_coordcomp_equal('img', ('0', '0', '1', '1'))
        self.assert_json_equal('LABELFORM', "title", '{[br/]}{[center]}{[u]}{[b]}Sessions{[/b]}{[/u]}{[/center]}')
        self.assert_coordcomp_equal("title", ('1', '0', '1', '1'))
        self.assert_coordcomp_equal("session", ('0', '1', '2', '1'))
