...
class GroupTest(LucteriosTest):
    ...
    def test_grouplist(self):
        ...
        self.assert_comp_equal('COMPONENTS/LABELFORM[@name="nb_group"]', "Nombre total de groupes: 0", (0, 2, 2, 1))
...
class SessionTest(LucteriosTest):
    ...
    def test_sessionlist(self):
        ...
        self.assert_comp_equal('COMPONENTS/LABELFORM[@name="nb_session"]', "Nombre total de sessions: 1", (0, 2, 2, 1))
