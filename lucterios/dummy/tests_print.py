...
class PrintTest(LucteriosTest):
    ...
    def testlist(self):
        ...
        self.assert_json_equal('', 'print_model/@0/kind', 'Liste')
        self.assert_json_equal('', 'print_model/@0/is_default', '1')
        self.assert_json_equal('', 'print_model/@1/name', 'label')
        self.assert_json_equal('', 'print_model/@1/kind', 'Etiquette')
        self.assert_json_equal('', 'print_model/@1/is_default', '0')
        self.assert_json_equal('', 'print_model/@2/name', 'reporting')
        self.assert_json_equal('', 'print_model/@2/kind', 'Rapport')
        self.assert_json_equal('', 'print_model/@2/is_default', '1')
    ...
    def testedit_listing(self):
        ...
        self.assert_comp_equal(('LABELFORM', "kind"), "Liste", (2, 2, 1, 1))
    ...
    def testedit_label(self):
        ...
        self.assert_comp_equal(('LABELFORM', "kind"), "Etiquette", (2, 2, 1, 1))
    ...
    def testclonedel_listing(self):
        ...
        self.assert_json_equal("", "print_model/@3/kind", 'Liste')
        self.assert_json_equal("", "print_model/@3/is_default", '0')
        ...
        self.assert_observer('core.custom', 'CORE', 'printModelList')
        self.assert_count_equal("print_model", 4)
        self.assert_json_equal("", "print_model/@0/is_default", '0')
        self.assert_json_equal("", "print_model/@1/is_default", '0')
        self.assert_json_equal("", "print_model/@2/is_default", '1')
        self.assert_json_equal("", "print_model/@3/is_default", '1')
    ...
    def testclonedel_label(self):
        ...
        self.assert_json_equal("", "print_model/@3/kind", 'Etiquette')
    ...
    def testreload_label(self):
        ...
        self.assert_json_equal('LABELFORM', "kind", "Etiquette")
