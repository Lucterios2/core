...
class ExampleTest(LucteriosTest):
    ...
    def testshow(self):
        ...
        self.assert_json_equal('LABELFORM', "date", "21 mars 2008")
        self.assert_json_equal('LABELFORM', "time", "15:21")
        self.assert_json_equal('LABELFORM', "valid", "Non")
    ...
    def test_other_addshow(self):
        ...
        self.assert_json_equal('IMAGE', "img", '/static/lucterios.dummy/images/10.png')
        self.assert_json_equal('LABELFORM', "bool", "Oui")
        ...
        self.assert_json_equal('LABELFORM', "bool", "Non")
    ...
    def test_printaction(self):
        ...
        self.assert_attrib_equal("page/body/text[1]", "left", "56.0" if six.PY3 else "54.0")
        self.assert_attrib_equal("page/body/text[1]", "width", "34.0" if six.PY3 else "35.0")
        ...
        self.assert_attrib_equal("page/body/text[3]", "left", "56.0" if six.PY3 else "54.0")
        self.assert_attrib_equal("page/body/text[3]", "width", "34.0" if six.PY3 else "35.0")
        ...
        self.assert_attrib_equal("page/body/text[4]", "left", "90.0" if six.PY3 else "89.0")
        self.assert_attrib_equal("page/body/text[4]", "width", "51.0" if six.PY3 else "52.0")
