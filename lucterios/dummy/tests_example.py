...
class ExampleTest(LucteriosTest):
    ...
    def test_other_addshow(self):
        ...
        self.assert_comp_equal('COMPONENTS/LABELFORM[@name="lbl_bool"]', "{[b]}bool{[/b]}", (1, 0, 1, 1))
        self.assert_comp_equal('COMPONENTS/CHECK[@name="bool"]', "0", (2, 0, 1, 1))
        self.assert_comp_equal('COMPONENTS/LABELFORM[@name="lbl_integer"]', "{[b]}integer{[/b]}", (1, 1, 1, 1))
        self.assert_comp_equal('COMPONENTS/FLOAT[@name="integer"]', "0", (2, 1, 1, 1))
        self.assert_comp_equal('COMPONENTS/LABELFORM[@name="lbl_real"]', "{[b]}real{[/b]}", (1, 2, 1, 1))
        self.assert_comp_equal('COMPONENTS/FLOAT[@name="real"]', "-5000.00", (2, 2, 1, 1))
        self.assert_comp_equal('COMPONENTS/LABELFORM[@name="lbl_text"]', "{[b]}text{[/b]}", (1, 3, 1, 1))
        self.assert_comp_equal('COMPONENTS/EDIT[@name="text"]', None, (2, 3, 1, 1))
        ...
        self.assert_comp_equal('COMPONENTS/IMAGE[@name="img"]', '/static/lucterios.dummy/images/10.png', (0, 0, 1, 6))
        self.assert_comp_equal('COMPONENTS/LABELFORM[@name="lbl_bool"]', "{[b]}bool{[/b]}", (1, 0, 1, 1))
        self.assert_comp_equal('COMPONENTS/LABELFORM[@name="bool"]', "Oui", (2, 0, 1, 1))
        self.assert_comp_equal('COMPONENTS/LABELFORM[@name="lbl_integer"]', "{[b]}integer{[/b]}", (1, 1, 1, 1))
        self.assert_comp_equal('COMPONENTS/LABELFORM[@name="integer"]', "13", (2, 1, 1, 1))
        self.assert_comp_equal('COMPONENTS/LABELFORM[@name="lbl_real"]', "{[b]}real{[/b]}", (1, 2, 1, 1))
        self.assert_comp_equal('COMPONENTS/LABELFORM[@name="real"]', "-159.37", (2, 2, 1, 1))
        self.assert_comp_equal('COMPONENTS/LABELFORM[@name="lbl_text"]', "{[b]}text{[/b]}", (1, 3, 1, 1))
        self.assert_comp_equal('COMPONENTS/LABELFORM[@name="text"]', "abc", (2, 3, 1, 1))
        self.factory.xfer = OtherAddModify()
        ...
        self.assert_comp_equal('COMPONENTS/LABELFORM[@name="lbl_bool"]', "{[b]}bool{[/b]}", (1, 0, 1, 1))
        self.assert_comp_equal('COMPONENTS/LABELFORM[@name="bool"]', "Non", (2, 0, 1, 1))
...
class ExampleTestJson(LucteriosTest):
    ...
    def testlist(self):
        ...
        self.assertEqual(self.response_json['comp'][2]['type'], 'GRID')
    ...
    def test_other_addshow(self):
        ...
        self.assert_value("lbl_bool", "{[b]}bool{[/b]}")
        self.assert_value("bool", False)
        self.assert_value("lbl_integer", "{[b]}integer{[/b]}")
        self.assert_value("integer", 0)
        self.assert_value("lbl_real", "{[b]}real{[/b]}")
        self.assert_value("real", -5000.0)
        self.assert_value("lbl_text", "{[b]}text{[/b]}")
