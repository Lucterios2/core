...
class ExampleTest(LucteriosTest):
    ...
    def test_printaction(self):
        ...
        self.assert_attrib_equal("page/body/text[1]", "width", "15.0")
        ...
        self.assert_attrib_equal("page/body/text[2]", "left", "40.0")
        self.assert_attrib_equal("page/body/text[2]", "width", "45.0")
        ...
        self.assert_attrib_equal("page/body/text[3]", "width", "15.0")
        ...
        self.assert_attrib_equal("page/body/text[4]", "left", "40.0")
