...
class DummyTest(LucteriosTest):
    ...
    def test_bidule1(self):
        ...
        self.assert_xml_equal('EXCEPTION/DEBUG_INFO', ' in fillresponse : raise LucteriosException(GRAVE, "Error of bidule")', (-76, -7))
    ...
    def test_bidule2(self):
        ...
        self.assert_xml_equal('EXCEPTION/DEBUG_INFO', ' in fillresponse : raise AttributeError("Other error:" + error)', (-70, -7))
